...
import { VehicleDirectoryClient } from "./vehicle-directory-client";
        ...
        <div className="mx-auto flex min-h-20 max-w-[1500px] flex-wrap items-center justify-between gap-3 px-6 py-4">
          ...
          >
            ...
            <Link
              ...
              className="rounded-xl border border-violet-400/50 px-4 py-2.5 text-violet-200 hover:border-violet-300"
            >
              Organizações
            </Link>
          </nav>
