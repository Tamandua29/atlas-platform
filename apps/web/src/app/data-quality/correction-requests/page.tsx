...
import { CorrectionRequestsClient } from "./correction-requests-client";
        ...
        <div className="mx-auto flex min-h-20 max-w-[1500px] items-center justify-between gap-4 px-5 py-4 md:px-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="mt-1 text-lg font-semibold text-white">Tratamento de solicitações de saneamento</h1>
            </div>
          </div>
          <div className="flex gap-2">
            <Link href="/data-quality/queue" className="rounded-xl bg-cyan-400 px-4 py-2.5 text-sm font-semibold text-slate-950">Fila de qualidade</Link>
