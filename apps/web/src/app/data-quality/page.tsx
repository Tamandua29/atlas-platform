      ...
      <header className="border-b border-slate-800/80 bg-[#070b17]/95">
        <div className="mx-auto flex min-h-20 max-w-[1500px] items-center justify-between gap-4 px-5 py-4 md:px-8">
          ...
          <div className="flex gap-2">
            <Link href="/identification-dashboard" className="rounded-xl bg-cyan-400 px-4 py-2.5 text-sm font-semibold text-slate-950">
              Painel
            </Link>
            <Link href="/review-queue" className="rounded-xl border border-slate-700 px-4 py-2.5 text-sm text-slate-300">
              Fila de revisão
            </Link>
          </div>
        </div>
