...
import { classifyDirectoryPriority, type JudicialAttention } from "@/features/intelligence/individual-directory-filter";
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json(
      { success: true, auditPersisted, correlationId, count: individuals.length, individuals },
